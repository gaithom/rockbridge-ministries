...
<section class="relative h-96 bg-cover bg-center overflow-hidden flex items-center justify-center" style="background-image: url('https://images.unsplash.com/photo-1549247775-654876b5d207?ixlib=rb-4.0.3&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=2000&h=900&fit=crop');">
  ...
  <div class="container mx-auto px-6 text-center relative z-20">
    ...
    <div class="max-w-7xl mx-auto">
      <div class="mb-16"><br><br>
        <h3 class="text-2xl md:text-3xl font-bold text-slate-800 mb-8 text-center">Kenyan Board of Directors</h3>
      ...
      <div v-if="selectedMember" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" @click="closeModal">
        <div class="bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-slate-100" @click.stop>
          <div class="flex justify-between items-start p-6 border-b bg-slate-50/60">
            <div class="flex-1">
          ...
          <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
            <div class="flex flex-col md:flex-row gap-6">
              ...
              <div class="md:w-2/3">
                <h4 class="text-xl font-semibold text-slate-900 mb-4">Biography</h4>
                <div class="space-y-4">
                  <p
...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    shortBio: "Psychology lecturer committed to serving social groups and women's empowerment.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Former secretary turned entrepreneur dedicated to full-time service for the needy.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Food service industry professional with a love for the Kenyan people.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Pharmaceutical industry expert and deacon committed to ministry and his community.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Foundation founder and real estate investor committed to supporting people with special needs.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Tax manager and ministry volunteer with a passion for serving homeless families.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Cultural anthropologist and development professional with extensive international experience.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Business executive and church leader dedicated to advancing God's mission in Kenya.",
    fullBio: [
  ...
  },
  {
    ...
    shortBio: "Business owner and ministry supporter with a deep heart for Kenya and its children.",
    fullBio: [
